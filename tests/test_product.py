...
def test_set_lower_price_without_consent(monkeypatch, sample_product):
...
def test_set_lower_price_invalid_input(monkeypatch, sample_product):
...
def test_set_non_positive_price(sample_product, capsys):
